...
SECRET_KEY = config("SECRET_KEY",default='django-insecure-$x^ka*ki8uprx$&llnxx$h&#c^-23!h6i1i6rdw_sx%s^$q+s3')
...
CALLBACK_URL = config("CALLBACK_URL",default="http://redreseller.com/verify")
